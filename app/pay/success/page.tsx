      ...
      <Card className="space-y-4 text-center">
        ...
        <div>
          ...
          <p className="mt-2 text-sm font-bold text-ink/65">
            {isSucceeded ? "La mesa se actualizó automáticamente." : isFailed ? "Vuelve a la cuenta para intentarlo nuevamente." : "Esto puede tardar unos segundos mientras llega Fintoc."}
          </p>
        </div>
        {payment ? (
          <Link
